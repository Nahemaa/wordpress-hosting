        ...
        <div class="max-w-md mx-auto my-10">
            ...
            <div class="m-7">
                <form action="">
                    ...
                    <div class="mb-6">
                        <a href="{{ route('dashboard') }}" button type="button" class="w-full px-3 py-4 text-white bg-purple-500 rounded-md focus:bg-purple-600 focus:outline-none text-center">Sign in</button></a>
                    </div>
                </form>
            </div>
        </div>
