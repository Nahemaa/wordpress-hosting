...
<nav class="text-black-200 bg-purple-500 body-font shadow w-full">
  <div class="container flex items-center p-6 mx-auto text-gray-800 capitalize dark:text-gray-300">
      ...
      <a href="{{ route('requests') }}" class="text-gray-800 hover:text-gray-800 dark:text-gray-200 border-b-2 border-purple-800 mx-1.5 sm:mx-6">Requests</a>
...
<p class="text-xl text-center font-bold m-5">Requests</p>
