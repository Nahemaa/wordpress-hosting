...
<nav class="text-black-200 bg-purple-500 body-font shadow w-full">
  <div class="container flex items-center p-6 mx-auto text-gray-800 capitalize dark:text-gray-300">
      ...
      <a href="{{ route('payroll') }}" class="text-gray-800 hover:text-gray-800 dark:text-gray-200 border-b-2 border-purple-800 mx-1.5 sm:mx-6">Payroll</a>
...
<p class="text-xl text-center font-bold m-5">Payroll</p>
...
<table class="rounded-t-lg m-5 w-5/6 mx-auto bg-purple-300 text-gray-800">
  ...
  <tr class="bg-gray-100 border-b border-purple-400">
    <td class="px-4 py-3">LG212387 John Luelle Gabales</td>
    <td class="px-4 py-3">Logistics</td>
    <td class="px-4 py-3">25,000</td>
    <td class="px-4 py-3">October 19, 2021 10:00 AM</td>
  </tr> 
<!-- each row -->

<tr class="bg-gray-100 border-b border-purple-400">
    <td class="px-4 py-3">IT32189 Francis Lorenze Deo Portillo</td>
    <td class="px-4 py-3">IT</td>
    <td class="px-4 py-3">32,000</td>
    <td class="px-4 py-3">October 15, 2021 10:00 AM</td>
  </tr> 
<!-- each row -->

<tr class="bg-gray-100 border-b border-purple-400">
    <td class="px-4 py-3">IT34189 Dave Carlos</td>
    <td class="px-4 py-3">IT</td>
    <td class="px-4 py-3">32,000</td>
    <td class="px-4 py-3">October 15, 2021 10:00 AM</td>
  </tr> 
...
<tr class="bg-gray-100 border-b border-purple-400">
    <td class="px-4 py-3">AD34189 Hu Tao</td>
    <td class="px-4 py-3">Administration</td>
    <td class="px-4 py-3">40,000</td>
    <td class="px-4 py-3">October 10, 2021 11:00 AM</td>
  </tr> 
<!-- each row -->
